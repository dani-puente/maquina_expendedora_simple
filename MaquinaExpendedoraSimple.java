public class MaquinaExpendedoraSimple {
    ...
    public MaquinaExpendedoraSimple (int precioDelBillete, String ciudadDestino){
        precioBillete = precioDelBillete;
        balanceClienteActual = 0;
        totalDineroAcumulado = 0;
        estacionOrigen = "León";
        estacionDestino = ciudadDestino;
    }
    ...
    /**
     * Metodo setter precio billete
     */
    public int setPrecioBillete(int precioNuevo){
        precioBillete = precioNuevo;
        return precioNuevo;
    }
    
    /**
     * Metodo que permite reducir el precio del billete
     */
